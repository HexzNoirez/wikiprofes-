    ...
    <a class="dropdown-item py-2 ps-3 border-radius-md" href="javascript:;">
      <div class="d-flex">
        ...
        <li class="nav-item ms-lg-auto my-auto ms-3 ms-lg-0 mt-2 mt-lg-0">
            <a class="nav-link nav-link-icon me-2" href="https://github.com/HexzNoirez" target="_blank">
        ...
        <li class="nav-item ms-lg-auto my-auto ms-3 ms-lg-0 mt-2 mt-lg-0">
            <form action="/logout" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="nav-link nav-link-icon me-2 btn btn-link text-sm z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Logout">
                    Logout
                </button>
            </form>
        </li>
